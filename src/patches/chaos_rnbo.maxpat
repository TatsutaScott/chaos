...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1115.0, 249.200000000000045, 75.0, 20.0 ],
					"text" : "[ click ]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 966.5, 139.0, 139.0, 20.0 ],
					"text" : "[ mouse position ]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1127.0, 275.200000000000045, 50.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 986.0, 304.0, 100.0, 22.0 ],
					"text" : "pack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1067.0, 274.0, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 986.0, 274.0, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 986.0, 166.0, 100.0, 100.0 ],
					"rightvalue" : 100,
					"topvalue" : 100
				}
...
,
					...
					"patching_rect" : [ 619.0, 478.0, 212.0, 22.0 ],
					"rnboattrcache" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 618.0, 528.0, 200.0, 20.0 ],
					"text" : "outdated ________"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 618.0, 238.0, 200.0, 20.0 ],
					"text" : "module files ________"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 706.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.0, 138.0, 95.0, 22.0 ],
...
,
					"patching_rect" : [ 619.0, 550.0, 212.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "e8d9b51b-d155-11ef-b51b-1068384f72df"
					}
,
					"snapshot" : 					{
						"filetype" : "C74Snapshot",
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "e8d9b51b-d155-11ef-b51b-1068384f72df",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20250113_1.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "ede136fd2ce6a65acbaf02b7eb14f9c1"
									}
...
,
					"text" : "rnbo~ chaos_outdated @autobuild 0",
					"varname" : "rnbo~[9]"
				}
...
,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 618.0, 327.0, 213.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "e9b2fdf3-d155-11ef-bdf3-1068384f72df"
					}
,
					"snapshot" : 					{
						"filetype" : "C74Snapshot",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 599.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 138.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 138.0, 85.0, 22.0 ],
					"text" : "prepend delay"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 411.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 138.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 326.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 138.0, 90.0, 22.0 ],
					"text" : "prepend reverb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 138.0, 92.0, 22.0 ],
					"text" : "prepend chorus"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-13" : [ "rnbo~[9]", "rnbo~[2]", 0 ],
			"obj-29" : [ "rnbo~[1]", "rnbo~[1]", 0 ],
			"obj-44" : [ "rnbo~[4]", "rnbo~[4]", 0 ],
			"obj-66" : [ "rnbo~[5]", "rnbo~[4]", 0 ],
			"obj-7" : [ "rnbo~[8]", "rnbo~[8]", 0 ],
			"obj-73" : [ "rnbo~[10]", "rnbo~[10]", 0 ],
			"obj-75" : [ "rnbo~", "rnbo~", 0 ],
			"obj-76" : [ "rnbo~[2]", "rnbo~[2]", 0 ],
			"obj-79" : [ "rnbo~[6]", "rnbo~[6]", 0 ],
			"obj-80" : [ "rnbo~[7]", "rnbo~[7]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "untitled_20250113_1.maxsnap",
				"bootpath" : "~/Documents/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../../Documents/Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
